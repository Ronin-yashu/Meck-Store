...
const Navbar = () => {
    ...
    return (
        ...
        >
            <Container size="4">
                <Flex justify="between" align="center" style={{ height: "70px" }} px="4">
                    {/* Logo */}
                    <motion.div
                    ...
                    >
                        <Link href="/" style={{ textDecoration: 'none', color: 'inherit' }}>
                            <Text size="7" weight="bold" style={{ cursor: 'pointer' }}>
                                Meck Store
                            </Text>
                        </Link>
                    </motion.div>
                ...
                <AnimatePresence>
                    {mobileMenuOpen && (
                        ...
                        >
                            <Box py="4" px="4" style={{ borderTop: '1px solid var(--gray-a4)' }}>
